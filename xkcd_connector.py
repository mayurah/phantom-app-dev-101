...
class XkcdConnector(BaseConnector):
    ...
    def __init__(self):
        ...
        super(XkcdConnector, self).__init__()
    ...
    def _handle_test_connectivity(self, param):
        ...
        ret_val, response = self._make_rest_call(
            '/info.0.json', action_result, params=None, headers=None
        )
...
def main():
    ...
    if username and password:
        try:
            login_url = XkcdConnector._get_phantom_base_url() + '/login'
